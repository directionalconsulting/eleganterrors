<div id="alert">
	...
	<a href="<!--[$base]-->/credits" title="<!--[$config->package]-->">
		...
		<svg height="100" width="100">
			...
			<text x="07" y="96" style="fill: firebrick; font-family: sans-serif; font-weight: 900; font-size: 11px; font-variant: small-caps; letter-spacing: 0.05em;"><!--[$config->package]--></text>
		</svg>
		<!--[php]-->if (!preg_match('%credits%',$_SERVER['REQUEST_URI'])):<!--[/php]-->
	</a>
	<!--[php]-->endif;<!--[/php]-->
